...
// city B then there is an edge between the cities. The cost of the edge can be the
// time that flight takes to reach city B from A, or the amount of fuel used for
// the journey. Represent this as a graph. The node can be represented by airport
